...
class PolicyControllerTest {
        ...
        void testPurchasePolicy_Success() throws Exception {
                // Updated payload to include a valid test card number
                PurchaseRequest request = new PurchaseRequest(
                                ...
                                365,
                                "CARD",
                                "4242424242424242", // A valid Visa test number
                                "John Doe",
                                12,
                                2030,
                                "123");
        ...
        void testPurchasePolicy_UserNotFound() throws Exception {
                // Updated payload for a valid request that will fail at the service level
                PurchaseRequest request = new PurchaseRequest(
                                99L, // User ID that doesn't exist
                                1L,
                                1L,
                                365,
                                "UPI",
