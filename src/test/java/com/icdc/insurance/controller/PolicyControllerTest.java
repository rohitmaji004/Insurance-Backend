...
@WebMvcTest(PolicyController.class) // Must be the actual controller
class PolicyControllerTest {
        ...
        @MockBean
        private PolicyService policyService; // Mock your service dependency

        @Test
        void testPurchasePolicy() throws Exception {
                PurchaseRequest request = new PurchaseRequest(1L, 1L, 1L, 365, "UPI");
        ...
        void testGetQuote() throws Exception {
                ...
                QuoteResponse response = QuoteResponse.builder()
                                .premium(5200.0)
                                .idv(450000.0)
                                .startDate(LocalDate.of(2025, 9, 9))
